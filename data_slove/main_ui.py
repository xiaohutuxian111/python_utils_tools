...
from PyQt5.QtWidgets import QApplication, QWidget, QDesktopWidget, QHBoxLayout, QVBoxLayout, QFileDialog
...
class MainWindow(QWidget):
    ...
    def init_form(self):
        ...
        txt_asin.setPlaceholderText("输入xlsx的路径,确认后点击添加")
